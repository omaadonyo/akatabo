<div
    x-data="{
        ...
        qrData() {
            const lines = [];
            if (this.number) lines.push('Receipt: ' + this.number);
...
>
    ...
    >
        <div style="background:linear-gradient(135deg,#047857,#10b981);padding:32px 32px 24px;">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;">
                ...
                <div style="text-align:right;">
                    <div style="font-size:28px;font-weight:800;color:#fff;letter-spacing:-0.03em;line-height:1;">RECEIPT</div>
        ...
        <div style="padding:28px 32px 8px;display:flex;justify-content:space-between;align-items:flex-start;">
            <div>
                <div :style="'font-size:10px;font-weight:600;color:'+textTertiary()+';text-transform:uppercase;letter-spacing:0.08em;margin-bottom:6px;'">Received From</div>
                ...
                <div x-show="status" style="margin-top:12px;display:inline-flex;align-items:center;gap:6px;padding:4px 14px;border-radius:100px;font-size:12px;font-weight:600;"
                    :style="{
                        background: this.isDark ? 'rgba(255,255,255,0.1)' : (
                            status === 'issued' ? '#f0fdf4' : '#f3f4f6'
                        ),
                        color: this.isDark ? '#6ee7b7' : (
                            status === 'issued' ? '#16a34a' : '#6b7280'
                        )
                    }">
                    <span style="width:6px;height:6px;border-radius:50%;display:inline-block;"
                        :style="'background:'+ (this.isDark ? '#6ee7b7' : (status === 'issued' ? '#22c55e' : '#9ca3af'))"
                    ></span>
        ...
        <div style="padding:4px 32px 24px;display:flex;gap:24px;">
            ...
            <div style="flex:1;">
                <div style="width:100%;">
                    ...
                    <div :style="'display:flex;justify-content:space-between;padding:12px 0 0;margin-top:8px;border-top:2px solid #047857;font-size:16px;font-weight:700;color:#047857;'">
        ...
        <div :style="'padding:16px 32px;border-top:1px solid '+borderColor()+';text-align:center;'">
            <div :style="'font-size:11px;color:'+textTertiary()+';font-weight:500;'">Payment received &mdash; thank you</div>
        </div>
    </div>
    ...
    >
        <div style="text-align:center;padding:40px;">
            <div style="width:72px;height:72px;margin:0 auto 20px;border-radius:16px;background:linear-gradient(135deg,#ecfdf5,#d1fae5);display:flex;align-items:center;justify-content:center;">
                <svg style="width:36px;height:36px;color:#10b981;" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
            </div>
            <div :style="'font-size:16px;color:'+textSecondary()+';font-weight:600;'">Receipt Preview</div>
